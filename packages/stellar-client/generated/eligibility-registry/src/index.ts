...
export interface Client {
   ...
   */
  is_active: ({attestation_key, now}: {attestation_key: Buffer, now: u64}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
   ...
   */
  set_oracle: ({admin, oracle, enabled}: {admin: string, oracle: string, enabled: boolean}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_attestation: ({attestation_key}: {attestation_key: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<AttestationRef>>>
   ...
   */
  revoke_attestation: ({actor, attestation_key, reason_code}: {actor: string, attestation_key: Buffer, reason_code: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  register_attestation: ({oracle, attestation}: {oracle: string, attestation: AttestationRef}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAAEkF0dGVzdGF0aW9uUmV2b2tlZAAAAAAAAgAAAAthdHRlc3RhdGlvbgAAAAAHcmV2b2tlZAAAAAADAAAAAAAAAA9hdHRlc3RhdGlvbl9rZXkAAAAD7gAAACAAAAABAAAAAAAAAAVhY3RvcgAAAAAAABMAAAABAAAAAAAAAAtyZWFzb25fY29kZQAAAAARAAAAAAAAAAI=",
        "",
        ...
        "AAAAAAAAAAAAAAAJaXNfYWN0aXZlAAAAAAAAAgAAAAAAAAAPYXR0ZXN0YXRpb25fa2V5AAAAA+4AAAAgAAAAAAAAAANub3cAAAAABgAAAAEAAAAB",
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAgAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAZvcmFjbGUAAAAAABMAAAABAAAD6QAAAAIAAAfQAAAADUNvbnRyYWN0RXJyb3IAAAA=",
        "AAAAAAAAAAAAAAAKc2V0X29yYWNsZQAAAAAAAwAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAZvcmFjbGUAAAAAABMAAAAAAAAAB2VuYWJsZWQAAAAAAQAAAAEAAAPpAAAAAgAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
        "AAAAAAAAAAAAAAAPZ2V0X2F0dGVzdGF0aW9uAAAAAAEAAAAAAAAAD2F0dGVzdGF0aW9uX2tleQAAAAPuAAAAIAAAAAEAAAPpAAAH0AAAAA5BdHRlc3RhdGlvblJlZgAAAAAH0AAAAA1Db250cmFjdEVycm9yAAAA",
        "AAAAAAAAAAAAAAAScmV2b2tlX2F0dGVzdGF0aW9uAAAAAAADAAAAAAAAAAVhY3RvcgAAAAAAABMAAAAAAAAAD2F0dGVzdGF0aW9uX2tleQAAAAPuAAAAIAAAAAAAAAALcmVhc29uX2NvZGUAAAAAEQAAAAEAAAPpAAAAAgAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
        "AAAAAAAAAAAAAAAUcmVnaXN0ZXJfYXR0ZXN0YXRpb24AAAACAAAAAAAAAAZvcmFjbGUAAAAAABMAAAAAAAAAC2F0dGVzdGF0aW9uAAAAB9AAAAAOQXR0ZXN0YXRpb25SZWYAAAAAAAEAAAPpAAAAAgAAB9AAAAANQ29udHJhY3RFcnJvcgAAAA==",
  ...
  public readonly fromJSON = {
    upgrade: this.txFromJSON<Result<void>>,
        ...
        get_attestation: this.txFromJSON<Result<AttestationRef>>,
        revoke_attestation: this.txFromJSON<Result<void>>,
        register_attestation: this.txFromJSON<Result<void>>
  }
}